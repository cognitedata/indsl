...
.. "auto_examples/data_quality/plot_gaps_identification.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_examples_data_quality_plot_gaps_identification.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_data_quality_plot_gaps_identification.py:
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /auto_examples/data_quality/images/sphx_glr_plot_gaps_identification_001.png
         :alt: Gap identification applied to a time series with four gaps and 35% removal, IQR, Z-Scores, Modified Z-Scores, Timedelta threshold
         :srcset: /auto_examples/data_quality/images/sphx_glr_plot_gaps_identification_001.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/data_quality/images/sphx_glr_plot_gaps_identification_002.png
         :alt: Gap identification to a time series with random gaps and 50% removal, IQR, Z-Scores, Modified Z-Scores, Timedelta threshold
         :srcset: /auto_examples/data_quality/images/sphx_glr_plot_gaps_identification_002.png
         :class: sphx-glr-multi-img
...
.. _sphx_glr_download_auto_examples_data_quality_plot_gaps_identification.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download sphx-glr-download-python
     ...
     :download:`Download Python source code: plot_gaps_identification.py <plot_gaps_identification.py>`



  .. container:: sphx-glr-download sphx-glr-download-jupyter

     :download:`Download Jupyter notebook: plot_gaps_identification.ipynb <plot_gaps_identification.ipynb>`
