...
def rolling_stddev(
    ...
    Rolling standard deviation computed for the time series values. This
    metric aims to measure the amount of variation or dispersion in the time series data.
